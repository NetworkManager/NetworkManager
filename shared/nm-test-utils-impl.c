                   ...
                   const char **subchannels)
{
	...
	return g_steal_pointer (&info.device);
}
...
static GObject *
_context_object_new_extra_context (GType gtype,
                                   const char *first_property_name,
                                   va_list var_args)
{
	...
	obj = nmtstc_context_object_new_valist (gtype, TRUE, first_property_name, var_args);
                                  ...
                                  va_list var_args)
{
	...
	if (nmtst_get_rand_uint32 () % 5 == 0)
		return _context_object_new_extra_context (gtype, first_property_name, var_args);
