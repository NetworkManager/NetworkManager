...
#define _NM_HASH_COMBINE_BOOLS_x_1( t, y)      ((y) ? ((t) (1LL <<  0)) : ((t) 0LL))
#define _NM_HASH_COMBINE_BOOLS_x_2( t, y, ...) ((y) ? ((t) (1LL <<  1)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_1  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_3( t, y, ...) ((y) ? ((t) (1LL <<  2)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_2  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_4( t, y, ...) ((y) ? ((t) (1LL <<  3)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_3  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_5( t, y, ...) ((y) ? ((t) (1LL <<  4)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_4  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_6( t, y, ...) ((y) ? ((t) (1LL <<  5)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_5  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_7( t, y, ...) ((y) ? ((t) (1LL <<  6)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_6  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_8( t, y, ...) ((y) ? ((t) (1LL <<  7)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_7  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_9( t, y, ...) ((y) ? ((t) (1LL <<  8)) : ((t) 0LL)) | (G_STATIC_ASSERT_EXPR (sizeof (t) >= 2), _NM_HASH_COMBINE_BOOLS_x_8  (t, __VA_ARGS__))
#define _NM_HASH_COMBINE_BOOLS_x_10(t, y, ...) ((y) ? ((t) (1LL <<  9)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_9  (t, __VA_ARGS__)
#define _NM_HASH_COMBINE_BOOLS_x_11(t, y, ...) ((y) ? ((t) (1LL << 10)) : ((t) 0LL)) | _NM_HASH_COMBINE_BOOLS_x_10 (t, __VA_ARGS__)
