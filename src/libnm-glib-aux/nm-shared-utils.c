...
gboolean
_nm_utils_is_specific_hostname(const char *name, bool allow_localhost)
{
...
{
    return _nm_utils_is_specific_hostname(name, FALSE);
}

gboolean
nm_utils_is_not_empty_hostname(const char *name)
{
    return _nm_utils_is_specific_hostname(name, TRUE);
}
