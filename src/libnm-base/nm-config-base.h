...
#define NM_CONFIG_KEYFILE_KEY_DEVICE_INITRD_CONNECTIONS         "initrd-connections"
...
#define NM_CONFIG_KEYFILE_KEY_DEVICE_WIFI_P2P_DEVICE_NAME "wifi-p2p.device-name"
