 ...
 * @NM_SETTING_HSR_PROTOCOL_VERSION_DEFAULT: default protocol version (HSRv0)
 * @NM_SETTING_HSR_PROTOCOL_VERSION_2010: HSRv0, IEC 62439-3:2010
 * @NM_SETTING_HSR_PROTOCOL_VERSION_2012: HSRv1, IEC 62439-3:2012
 *
 * #NMSettingHsrProtocolVersion values indicate the protocol version (HSRv0/HSRv1)
 *
 * Since: 1.56
 */
typedef enum {
    NM_SETTING_HSR_PROTOCOL_VERSION_DEFAULT = 0,
    NM_SETTING_HSR_PROTOCOL_VERSION_2010    = 0,
    NM_SETTING_HSR_PROTOCOL_VERSION_2012    = 1,
} NMSettingHsrProtocolVersion;
