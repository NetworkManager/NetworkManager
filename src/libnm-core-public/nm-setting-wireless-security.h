 ...
 * @NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_PIN: use PIN method, entering the
 *   PIN that the other device displays
 * @NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_PIN_DISPLAY: use PIN method,
 *   displaying a PIN for the other device to enter. Only supported for Wi-Fi
 *   P2P connections. Since: 1.60
 *
...
typedef enum /*< flags >*/ {
    ...
    NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_PIN_DISPLAY = 0x00000010,
} NMSettingWirelessSecurityWpsMethod;
