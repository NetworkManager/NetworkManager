 ...
 * @NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT: use the global default value
 * @NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_NO: do not add DNS routes
 * @NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_YES: do add DNS routes
 *
 * #NMSettingIPConfigAddDnsRoutes indicates whether routes are added
 * automatically for each DNS that is associated with this connection.
 *
 * Since: 1.52
 */
typedef enum {
    NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT = -1,
    NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_NO      = 0,
    NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_YES     = 1,
} NMSettingIPConfigAddDnsRoutes;
...
#define NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES      "add-dns-routes"
...
NMSettingIPConfigAddDnsRoutes nm_setting_ip_config_get_add_dns_routes(NMSettingIPConfig *setting);
