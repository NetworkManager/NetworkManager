...
#define NM_SETTING_IP_CONFIG_DHCP_CLIENT_SEND_HOSTNAME "dhcp-client-send-hostname"
...
NMTernary nm_setting_ip_config_get_dhcp_client_send_hostname(NMSettingIPConfig *setting);
