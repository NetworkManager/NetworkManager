...
/**
 * nm_setting_ip_config_get_add_dns_routes:
 * @setting: the #NMSettingIPConfig
 *
 * Returns: the #NMSettingIPConfig:add-dns-routes property of the setting
 *
 * Since: 1.52
 **/
NMSettingIPConfigAddDnsRoutes
nm_setting_ip_config_get_add_dns_routes(NMSettingIPConfig *setting)
{
    g_return_val_if_fail(NM_IS_SETTING_IP_CONFIG(setting),
                         NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT);

    return NM_SETTING_IP_CONFIG_GET_PRIVATE(setting)->add_dns_routes;
}
...
_nm_sett_info_property_override_create_array_ip_config(int addr_family)
{
    ...
    _nm_properties_override_gobj(
        properties_override,
        obj_properties[PROP_ADD_DNS_ROUTES],
        &nm_sett_info_propert_type_direct_enum,
        .direct_offset =
            NM_STRUCT_OFFSET_ENSURE_TYPE(int, NMSettingIPConfigPrivate, add_dns_routes),
        .direct_data.enum_gtype = NM_TYPE_SETTING_IP_CONFIG_ADD_DNS_ROUTES);
...
nm_setting_ip_config_class_init(NMSettingIPConfigClass *klass)
{
    ...
    /**
     * NMSettingIPConfig:add-dns-routes:
     *
     ...
     * set to %NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT, the value from global
     * configuration is used; if no global default is defined, this feature is disabled.
     *
     * Since: 1.52
     */
    obj_properties[PROP_ADD_DNS_ROUTES] =
        g_param_spec_int(NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES,
                         "",
                         "",
                         NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT,
                         NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_YES,
                         NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES_DEFAULT,
                         G_PARAM_READWRITE | G_PARAM_EXPLICIT_NOTIFY | G_PARAM_STATIC_STRINGS);
