...
skip_addr:
        ...
        nm_netns_watcher_remove_all(self->priv.netns, _NETNS_WATCHER_MPTCP_IPV6_TAG(self), FALSE);
...
finalize(GObject *object)
{
    ...
    if (self->priv.netns) {
        ...
        nm_netns_watcher_remove_all(self->priv.netns, _NETNS_WATCHER_MPTCP_IPV6_TAG(self), TRUE);
    }
