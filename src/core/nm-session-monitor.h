...
#define NM_SESSION_MONITOR_GET_CLASS(o) \
    (G_TYPE_INSTANCE_GET_CLASS((o), NM_TYPE_SESSION_MONITOR, NMSessionMonitorClass))
...
gboolean nm_session_monitor_session_exists(NMSessionMonitor *self, uid_t uid, gboolean active);
