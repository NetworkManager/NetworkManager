...
#define _T(up,                                               \
    ...
    _T(TRUE,
       ...
       "chain netdev nm-mlag-bond0 tx-redirect-igmp-reports-eth3 { type filter hook egress device "
       "eth3 priority filter + 1; }\012add rule netdev nm-mlag-bond0 tx-redirect-igmp-reports-eth3 "
       "igmp type { membership-report-v1, membership-report-v2, membership-report-v3 } fwd to "
       "eth2\012add rule netdev nm-mlag-bond0 tx-redirect-igmp-reports-eth3 icmpv6 type { "
       "mld-listener-report, mld2-listener-report } fwd to eth2\012");
