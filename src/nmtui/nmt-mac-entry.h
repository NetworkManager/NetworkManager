...
#define NMT_MAC_ENTRY_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), NMT_TYPE_MAC_ENTRY, NmtMacEntryClass))
...
NmtNewtWidget *nmt_mac_entry_new(int width, int mac_length, NmtMacEntryType type);
