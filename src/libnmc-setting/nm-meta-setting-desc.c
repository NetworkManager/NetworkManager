...
static const NMMetaPropertyInfo *const property_infos_IP4_CONFIG[] = {
    ...
    PROPERTY_INFO (NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES, DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_ADD_DNS_ROUTES,
                   .property_type =                &_pt_gobject_enum,
    ),
...
static const NMMetaPropertyInfo *const property_infos_IP6_CONFIG[] = {
    ...
    PROPERTY_INFO (NM_SETTING_IP_CONFIG_ADD_DNS_ROUTES, DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_ADD_DNS_ROUTES,
                   .property_type =                &_pt_gobject_enum,
    ),
