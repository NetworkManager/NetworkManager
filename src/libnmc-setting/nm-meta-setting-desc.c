...
static const NMMetaPropertyInfo *const property_infos_IP4_CONFIG[] = {
    ...
    PROPERTY_INFO (NM_SETTING_IP_CONFIG_DHCP_SEND_RELEASE, DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_CLIENT_SEND_HOSTNAME,
        .property_type =                &_pt_gobject_ternary,
    ),
...
static const NMMetaPropertyInfo *const property_infos_IP6_CONFIG[] = {
    ...
    PROPERTY_INFO (NM_SETTING_IP_CONFIG_DHCP_SEND_RELEASE, DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_CLIENT_SEND_HOSTNAME,
        .property_type =                &_pt_gobject_ternary,
    ),
