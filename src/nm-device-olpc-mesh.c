...
nm_device_olpc_mesh_init (NMDeviceOlpcMesh * self)
{
	...
	nm_device_set_device_type (NM_DEVICE (self), NM_DEVICE_TYPE_OLPC_MESH);
}
...
nm_device_olpc_mesh_class_init (NMDeviceOlpcMeshClass *klass)
{
	...
	parent_class->act_stage4_ip_config_timeout = real_act_stage4_ip4_config_timeout;
                         ...
                         gboolean managed)
{
	...
	return NM_DEVICE_OLPC_MESH (obj);
}
