...
static NMActStageReturn
link_change (NMDeviceWireGuard *self,
             gboolean called_from_stage2,
...
{
	return link_change (NM_DEVICE_WIREGUARD (device), TRUE, out_failure_reason);
}
