...
test_wireguard_peer(void)
{
    ...
    struct {
        ...
        {
            .str    = "MWEKYcE9MEh5RoGDuJYrJ2YgkoosONGhuHRBAC00e14=",
            .rtrip  = "MWEKYcE9MEh5RoGDuJYrJ2YgkoosONGhuHRBAC00e14=",
            .pubkey = "MWEKYcE9MEh5RoGDuJYrJ2YgkoosONGhuHRBAC00e14=",
        },
        {
            /* Test with an IPv4 endpoint */
            .str      = "+DIX0qWKQ4E6hy7MWzsSRXjqAHCtffWrXTdJPe/xS04="
                        " endpoint=1.2.3.4:5555",
            .rtrip    = "+DIX0qWKQ4E6hy7MWzsSRXjqAHCtffWrXTdJPe/xS04="
                        " endpoint=1.2.3.4:5555",
            .pubkey   = "+DIX0qWKQ4E6hy7MWzsSRXjqAHCtffWrXTdJPe/xS04=",
            .endpoint = "1.2.3.4:5555",
        },
        {
            /* Test with an IPv6 endpoint */
            .str      = "aPsdPkeqH4l5Nax3g3e8A8f7g0hJk2l3m4N5p6q7R8s="
                        " endpoint=[fd01:db8::1]:8080",
            .rtrip    = "aPsdPkeqH4l5Nax3g3e8A8f7g0hJk2l3m4N5p6q7R8s="
                        " endpoint=[fd01:db8::1]:8080",
            .pubkey   = "aPsdPkeqH4l5Nax3g3e8A8f7g0hJk2l3m4N5p6q7R8s=",
            .endpoint = "[fd01:db8::1]:8080",
        },
        {
            /* Test with a single IPv4 allowed-ip */
            .str             = "s4fmZZA3gMGVv8+0hkSwrmeLC6nNd+Pd6DlSaufLKhY="
                               " allowed-ips=172.16.0.0/16",
            .rtrip           = "s4fmZZA3gMGVv8+0hkSwrmeLC6nNd+Pd6DlSaufLKhY="
                               " allowed-ips=172.16.0.0/16",
        ...
        {
            /* Test with multiple allowed-ips */
            .str             = "V02J2zmCi2LHX2KMK+ZOgDNhZzK4JXjGNr7CYfz9DxQ="
                               " allowed-ips=192.168.2.0/24;2001:db8:a::/48",
            .rtrip           = "V02J2zmCi2LHX2KMK+ZOgDNhZzK4JXjGNr7CYfz9DxQ="
                               " allowed-ips=192.168.2.0/24;2001:db8:a::/48",
        ...
        {
            /* Test with persistent-keepalive */
            .str       = "D1FTp8Wy1oJQI045yXo9EMdxJqjXHC3VhTCPTh3lSQM="
                         " persistent-keepalive=25",
            .rtrip     = "D1FTp8Wy1oJQI045yXo9EMdxJqjXHC3VhTCPTh3lSQM="
                         " persistent-keepalive=25",
            .pubkey    = "D1FTp8Wy1oJQI045yXo9EMdxJqjXHC3VhTCPTh3lSQM=",
            .keepalive = 25,
        },
        {
            /* Test with a preshared-key but no flags (should default to 0) */
            .str       = "H5cWWgpWgJH+nHFhsuPS3adgZHuc6Z4cRzfiNRTinE0="
                         " preshared-key=16uGwZvROnwyNGoW6Z3pvJB5GKbd6ncYROA/FFleLQA=",
            .rtrip     = "H5cWWgpWgJH+nHFhsuPS3adgZHuc6Z4cRzfiNRTinE0="
                         " preshared-key=16uGwZvROnwyNGoW6Z3pvJB5GKbd6ncYROA/FFleLQA="
        ...
        {
            /* Full test with non-canonical order and extra whitespace */
            .str = "gqQ9dUqKQNfz/KOqELJpS0MKBvRcYWL8sm/LGEWKKQY="
                   "  preshared-key=EVVP8pOzn8R3nQtv62/hnGsXzyagEgykSboFe4EFhQc="
                   " endpoint=vpn.example.com:51820 "
                   " preshared-key-flags=1"
                   " persistent-keepalive=45"
                   " allowed-ips=0.0.0.0/0;::/0",
            /* Canonical output has a specific order and single spaces */
            .rtrip           = "gqQ9dUqKQNfz/KOqELJpS0MKBvRcYWL8sm/LGEWKKQY="
                               " allowed-ips=0.0.0.0/0;::/0"
                               " endpoint=vpn.example.com:51820"
                               " persistent-keepalive=45"
                               " preshared-key=EVVP8pOzn8R3nQtv62/hnGsXzyagEgykSboFe4EFhQc="
    ...
    for (i = 0; i < G_N_ELEMENTS(tests); i++) {
        ...
        peer = _nm_utils_wireguard_peer_from_string(tests[i].str, &error);
        g_assert_no_error(error);
        g_assert_nonnull(peer);

        newstr = _nm_utils_wireguard_peer_to_string(peer);
        g_assert_nonnull(newstr);
        g_assert_cmpstr(tests[i].rtrip, ==, newstr);
