...
class TestNmCloudSetup(unittest.TestCase):
    ...
    def test_oci_vlans(self):
        ...
        nmc.pexp.expect("device has no suitable applied connection. Skip")
        nmc.pexp.expect('configuring "eth1"')
        nmc.pexp.expect("device has no suitable applied connection. Skip")
        ...
        # This time we're reapplying
        nmc.pexp.expect('configuring "macvlan2"')
        nmc.pexp.expect("reapply connection")
        nmc.pexp.expect('connection "connection-3"')
        nmc.pexp.expect("reapplied")
        nmc.pexp.expect('configuring "macvlan2.700"')
        nmc.pexp.expect("reapply connection")
        nmc.pexp.expect('connection "connection-4"')
        nmc.pexp.expect("reapplied")
        nmc.pexp.expect(pexpect.EOF)
