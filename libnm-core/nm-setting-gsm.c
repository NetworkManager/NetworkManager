...
nm_setting_gsm_class_init (NMSettingGsmClass *klass)
{
	...
	_properties_override_add_virt (properties_override, "allowed-bands", &nm_sett_info_propert_type_deprecated_ignore_u);
	_properties_override_add_virt (properties_override, "network-type", &nm_sett_info_propert_type_deprecated_ignore_i);
