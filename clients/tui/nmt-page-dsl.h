...
#define NMT_PAGE_DSL_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), NMT_TYPE_PAGE_DSL, NmtPageDslClass))
...
NmtEditorPage *nmt_page_dsl_new(NMConnection *conn, NmtDeviceEntry *deventry);
