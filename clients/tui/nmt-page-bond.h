...
#define NMT_PAGE_BOND_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), NMT_TYPE_PAGE_BOND, NmtPageBondClass))
...
NmtEditorPage *nmt_page_bond_new(NMConnection *conn, NmtDeviceEntry *deventry);
