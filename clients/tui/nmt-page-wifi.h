...
#define NMT_PAGE_WIFI_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), NMT_TYPE_PAGE_WIFI, NmtPageWifiClass))
...
NmtEditorPage *nmt_page_wifi_new(NMConnection *conn, NmtDeviceEntry *deventry);
