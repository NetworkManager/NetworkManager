...
#define NMT_PAGE_TEAM_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), NMT_TYPE_PAGE_TEAM, NmtPageTeamClass))
...
NmtEditorPage *nmt_page_team_new(NMConnection *conn, NmtDeviceEntry *deventry);
