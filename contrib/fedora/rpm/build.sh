...
SOURCE_README_IFCFG_FILES="$(abs_path "$SOURCE_README_IFCFG_FILES" "$SCRIPTDIR/README_IFCFG_FILES")" || die "invalid \$SOURCE_README_IFCFG_FILES argument"
...
cp "$SOURCE_README_IFCFG_FILES" "$TEMP/SOURCES/README_IFCFG_FILES" || die "Could not copy source $SOURCE_README_IFCFG_FILES to $TEMP/SOURCES"
