...
get_nm_git_bundle() {
    ...
    if [ -z "$NM_GIT_BUNDLE" ]; then
        ...
        NM_GIT_BUNDLE='https://download.copr.fedorainfracloud.org/results/networkmanager/NetworkManager-main/fedora-41-x86_64/06008259-nm-git-bundle/nm-git-bundle-20230606-102458.noarch.rpm'
    fi
    mkdir nm-git-bundle
    pushd nm-git-bundle
